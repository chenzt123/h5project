                    ...
                    <div class="l_three clearfix">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                value="${lm1.drawid}" class="layui-input"  maxlength="10">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">三肖：</label>
                            <div class="layui-input-block">
                                <input type="text" name="zodic" lay-verify="required" maxlength="10" autocomplete="off" placeholder="请输入三肖(必填项)" value="${lm1.zodic}" class="layui-input">
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="opgame"  autocomplete="off" placeholder="请输入开奖号码" value="${lm1.opgame}" class="layui-input">
                            </div>
                        </div>
                    </div>
                    <div class="l_three clearfix">
