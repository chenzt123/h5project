        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins l_ibox">
                ...
                <form class="layui-form" action="../sysMenu/saveOrUpdate" method="post" id="editForm">
                    ...
                    <div class="l_three clearfix">
                        <div class="layui-form-item">
                            <label class="layui-form-label">诗：</label>
                            <div class="layui-input-block">
                                <input type="text" name="zodic2" lay-verify="required"  autocomplete="off" placeholder="请输入上线id(必填项)"
                                       value="${lm.zodic2}" class="layui-input" >
                                <%--<span style="color:red">(11个中文字)</span>--%>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">字关：</label>
                            <div class="layui-input-block">
                                <input type="text" name="zodic3" lay-verify="required"  autocomplete="off" placeholder="请输入上线id(必填项)"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="zodic4" lay-verify="required"  autocomplete="off" placeholder="请输入上线id(必填项)"
                    ...
                    <div class="l_three clearfix">
                        <div class="layui-form-item">
                            <label class="layui-form-label">解：</label>
                            <div class="layui-input-block">
                                <input type="text" name="zodic5" lay-verify="required"  autocomplete="off" placeholder="请输入上线id(必填项)"
