                ...
                <form class="layui-form" action="../sysMenu/saveOrUpdate" method="post" id="editForm">
                    ...
                    <div class="l_three clearfix">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="opgame" lay-verify="required"  autocomplete="off" placeholder="请输入内容(必填项)"
                                       value="${lm.opgame}" class="layui-input" >
                                <%--<span style="color:red">(11个中文字)</span>--%>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">开奖id：</label>
                            <div class="layui-input-block">
                                <input type="text" name="pid" lay-verify="required"  autocomplete="off" placeholder="开奖id(必填项)"
